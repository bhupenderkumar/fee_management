  ...
  return (
    <div className="bg-white min-h-screen lg:min-h-0">
      ...
      <div className="print:hidden mb-4 lg:mb-6 flex flex-col sm:flex-row justify-end gap-3">
        <button
          onClick={handlePrint}
          className="flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-sm lg:text-base"
        >
        ...
        <button
          onClick={handleShare}
          className="flex items-center justify-center gap-2 px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 text-sm lg:text-base"
        >
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-4 lg:p-8 print:shadow-none print:border-none">
        ...
        <div className="border border-gray-200 rounded-lg p-4 lg:p-6 mb-4 lg:mb-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center py-2 border-b border-gray-100">
              ...
              <span className="text-lg lg:text-2xl font-bold text-green-600">₹{payment.amount_received.toFixed(2)}</span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-gray-100">
            ...
            <div className="flex justify-between items-center py-2 border-b border-gray-100">
              ...
              <span className={`font-medium text-sm lg:text-base ${payment.balance_remaining > 0 ? 'text-red-600' : 'text-green-600'}`}>
        ...
        {/* Notes */}
        {payment.notes && (
          <div className="bg-blue-50 rounded-lg p-4 mb-4 lg:mb-6">
